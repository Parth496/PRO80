...
import { Text, View, Alert, SafeAreaView, FlatList, Platform, ImageBackground } from 'react-native';
...
export default class MeteorScreen extends Component {
    ...
    renderItem=({item})=>{
        let meteor=item
        let big_img,speed,size;
        if(meteor.threat_score<=30)
        {
            bg_img=require("../assets/meteor_bg1.png")
            speed=require("../assets/meteror_speed3.gif")
            size=100
        }
                ...
                <ImageBackground source={bg_img} style={styles.backgroundImage}>
                    <View styles={styles.gifContainer}>
                        ...
                        <View>
                            ...
                            <Text style={[styles.cardText,{marginTop:5,marginLeft:50}]}>MinimumDiameter(km)-{item.estimated_diameter.kilometers.estimated_diameter_min}</Text>
                            <Text style={[styles.cardText,{marginTop:5,marginLeft:50}]}>MaximumDiameter(km)-{item.estimated_diameter.kilometers.estimated_diameter_max}</Text>
                        </View>
                    </View>
                </ImageBackground>
            </View>
